...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('audit_events')->updateOrInsert(['id' => '93000000-0000-4000-8000-000000000001'], [
            ...
            'device_fingerprint' => 'localhost-demo-device',
            'severity' => 'info',
        ...
        $listRows = [
            ...
            ['super-admin', 'architecture_controls', 'Laravel API Runtime', 'Current localhost backend', 'ready', 'Server', null, null, [], 1],
            ['super-admin', 'architecture_controls', 'MySQL NUERS Database', 'Operational local database', 'ready', 'Database', null, null, [], 2],
